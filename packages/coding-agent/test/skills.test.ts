...
import { type Skill as CapabilitySkill, skillCapability } from "oh-my-gui-pi/capability/skill";
import { getCapability } from "oh-my-gui-pi/discovery";
import { loadSkills, loadSkillsFromDir, type Skill } from "oh-my-gui-pi/extensibility/skills";
