...
import { clearCache as clearFsCache } from "oh-my-gui-pi/capability/fs";
import {
	clearClaudePluginRootsCache,
	listClaudePluginRoots,
	parseClaudePluginsRegistry,
} from "oh-my-gui-pi/discovery/helpers";
import { discoverAgents } from "oh-my-gui-pi/task/discovery";
