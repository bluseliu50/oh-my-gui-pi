...
import type { MarketplacePluginEntry } from "oh-my-gui-pi/extensibility/plugins/marketplace";
import { resolvePluginSource } from "oh-my-gui-pi/extensibility/plugins/marketplace";
