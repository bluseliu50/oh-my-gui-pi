...
import * as imageResize from "oh-my-gui-pi/utils/image-resize";
import * as toolsManager from "oh-my-gui-pi/utils/tools-manager";
import * as scrapers from "oh-my-gui-pi/web/scrapers/types";
import * as scraperUtils from "oh-my-gui-pi/web/scrapers/utils";
