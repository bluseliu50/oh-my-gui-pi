...
import { handleCheatSh } from "oh-my-gui-pi/web/scrapers/cheatsh";
import { handleRfc } from "oh-my-gui-pi/web/scrapers/rfc";
import { handleTldr } from "oh-my-gui-pi/web/scrapers/tldr";
