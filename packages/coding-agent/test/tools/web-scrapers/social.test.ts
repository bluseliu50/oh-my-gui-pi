...
import { handleReddit } from "oh-my-gui-pi/web/scrapers/reddit";
import { handleStackOverflow } from "oh-my-gui-pi/web/scrapers/stackoverflow";
import { handleTwitter } from "oh-my-gui-pi/web/scrapers/twitter";
