...
import { handleBiorxiv } from "oh-my-gui-pi/web/scrapers/biorxiv";
import { handleOpenLibrary } from "oh-my-gui-pi/web/scrapers/openlibrary";
import { handleWikidata } from "oh-my-gui-pi/web/scrapers/wikidata";
