...
import { handleDevTo } from "oh-my-gui-pi/web/scrapers/devto";
import { handleGitLab } from "oh-my-gui-pi/web/scrapers/gitlab";
import { handleHackerNews } from "oh-my-gui-pi/web/scrapers/hackernews";
import { handleLobsters } from "oh-my-gui-pi/web/scrapers/lobsters";
