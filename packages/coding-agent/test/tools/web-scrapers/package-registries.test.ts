...
import { handleCratesIo } from "oh-my-gui-pi/web/scrapers/crates-io";
import { handleGoPkg } from "oh-my-gui-pi/web/scrapers/go-pkg";
import { handleHex } from "oh-my-gui-pi/web/scrapers/hex";
import { handleNpm } from "oh-my-gui-pi/web/scrapers/npm";
import { handlePubDev } from "oh-my-gui-pi/web/scrapers/pub-dev";
import { handlePyPI } from "oh-my-gui-pi/web/scrapers/pypi";
