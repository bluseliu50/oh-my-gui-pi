...
import { handleArxiv } from "oh-my-gui-pi/web/scrapers/arxiv";
import { handleIacr } from "oh-my-gui-pi/web/scrapers/iacr";
import { handlePubMed } from "oh-my-gui-pi/web/scrapers/pubmed";
import { handleSemanticScholar } from "oh-my-gui-pi/web/scrapers/semantic-scholar";
import type { RenderResult } from "oh-my-gui-pi/web/scrapers/types";
