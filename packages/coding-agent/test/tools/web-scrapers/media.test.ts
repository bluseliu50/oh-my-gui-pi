...
import { handleHuggingFace } from "oh-my-gui-pi/web/scrapers/huggingface";
import { handleSpotify } from "oh-my-gui-pi/web/scrapers/spotify";
import { handleVimeo } from "oh-my-gui-pi/web/scrapers/vimeo";
