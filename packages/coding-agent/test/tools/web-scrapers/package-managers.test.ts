...
import { handleAur } from "oh-my-gui-pi/web/scrapers/aur";
import { handleBrew } from "oh-my-gui-pi/web/scrapers/brew";
import { handleMaven } from "oh-my-gui-pi/web/scrapers/maven";
import { handleNuGet } from "oh-my-gui-pi/web/scrapers/nuget";
import { handlePackagist } from "oh-my-gui-pi/web/scrapers/packagist";
import { handleRubyGems } from "oh-my-gui-pi/web/scrapers/rubygems";
