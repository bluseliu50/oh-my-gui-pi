...
import { handleArtifactHub } from "oh-my-gui-pi/web/scrapers/artifacthub";
import { handleCoinGecko } from "oh-my-gui-pi/web/scrapers/coingecko";
import { handleDiscogs } from "oh-my-gui-pi/web/scrapers/discogs";
