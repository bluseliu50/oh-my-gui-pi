...
import { type PendingExtensionRequest, requestRpcEditor } from "oh-my-gui-pi/modes/rpc/rpc-mode";
import type { RpcExtensionUIRequest } from "oh-my-gui-pi/modes/rpc/rpc-types";
